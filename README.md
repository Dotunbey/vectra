...
**Vectra**, a lightweight, distributed-ready vector search engine designed specially for high-throughput similarity search. It implements **Scalar Quantization (SQ8)** to reduce memory footprints by **75%** while maintaining **>98% recall** on standard benchmarks.
